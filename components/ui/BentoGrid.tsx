...
export const BentoGridItem = ({
  ...
  const rightLists = ["NodeJS", "TailwindCSS", "MongoDB", "GraphQL"];

  const [copied, setCopied] = useState(false);
  const handleCopy = () => {
    const text = "sisirjangthapa@gmail.com";
            ...
            <div className="flex gap-1 lg:gap-4 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 md:gap-2 lg:gap-2">
                {leftLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-3 lg:px-3 py-2 px-3 text-xs lg:text-[15px] opacity-50 
